...
great for writing and diffing, but calmer to *read* as rich text. Pages
...
`mdo --open` never leaves `.html` files beside your Markdown, all output goes
...
- **Windows** - right-click a `.md` file → **Open as HTML** (per-user
  registry entries; admin rights not needed). Release ZIPs include a
...
That's the question this phase of the project exists to answer, and
you can help:
...
including how this project is built.
...
Mdo is dual-licensed under either the [MIT License](LICENSE-MIT) or the
